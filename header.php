...
<body <?php body_class(); ?>>
<p class="sr-only"><a href="#content"><?php _e('Skip to Content'); ?></a></p><?php /* used for accessibility, particularly for screen reader applications */ ?>
<header>
	<div class="container">
		<div id="title">
